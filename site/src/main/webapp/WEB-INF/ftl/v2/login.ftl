		...
		<div class="row">
			...
			<div class="span4">
				<div id="login-box" class="well well-small">
					...
					<hr>
					<a href="${ContextPath}/connector/qq_login"><img alt="QQ登录" src="${ContextPath}/assets/v2/img/connector/Connect_logo_7.png" width="63" height="24"></a>
					<a href="${ContextPath}/connector/weibo_login" class="pull-right"><img alt="用微博登录" src="${ContextPath}/assets/v2/img/connector/loginButton_24.png" width="102" height="24"></a>
					<div class="clearfix"></div>
				</div>
			</div>
		</div>
