	...
	<div class="row">
		...
		<div class="span4">
			...
			<ul>
				...
				<li><a href="${ContextPath}/connector/weibo_login" class="mg"><img alt="用微博登录" src="${ContextPath}/assets/v2/img/connector/loginButton_24.png" width="102" height="24"></a></li>
			</ul>
		</div>
	</div>
</div>
