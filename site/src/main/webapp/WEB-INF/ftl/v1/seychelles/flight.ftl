...
<div id="page-content" class="clearfix">
	<div class="row-fluid">
		<h3 class="header smaller lighter blue">
			塞舌尔航班
			<button type="button" class="btn btn-mini btn-primary pull-right" onclick="cqlybest.go('#main-content', '${ContextPath}/seychelles/flight/update.do');">增加航班</button>
		</h3>
...
$('#main-list-table').dataTable({
	...
	fnServerData: function (sSource, aoData, fnCallback, oSettings) {
		...
		cqlybest.go('#main-content', '${ContextPath}/seychelles/flight.do?' + $.param(q));
	}
});
</script>