		...
		<div class="span12">
			<div class="control-group">
				...
				<div class="controls image-gallery">
					<button type="button" class="btn btn-primary btn-mini action action-add picture" data-name="islandId" data-value="${island.id}" data-url="${ContextPath}/seychelles/hotel/picture/add.do">添加</button>
						...
						<#list island.hotelPictures as image>
							<li class="span3">
								<div class="thumbnail">
									...
									<div class="caption">
										<p><a href="#" class="editable" data-pk="${image.id}" data-name="title" data-type="text" data-value="${image.title!}" data-url="${ContextPath}/seychelles/hotel/picture/update.do"></a></p>
										<p><a href="#" class="editable" data-pk="${image.id}" data-name="description" data-type="textarea" data-url="${ContextPath}/seychelles/hotel/picture/update.do">${image.description!?html}</a></p>
										<button class="delete btn btn-danger" type="button" data-id="${image.id}" data-url="${ContextPath}/seychelles/hotel/picture/delete.do">刪除</button>
									</div>
								</div>
							</li>
							<#if image_index%4==3>
