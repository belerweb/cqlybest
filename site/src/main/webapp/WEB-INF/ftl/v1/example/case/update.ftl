...
<div id="page-content" class="clearfix">
	<div class="row-fluid">
		...
		<#if case?has_content>
		<form method="POST" action="${ContextPath}/admin/example/case/update.do" class="form-horizontal">
			<input type="hidden" name="id" value="${case.id}">
		<#else>
		<form method="POST" action="${ContextPath}/admin/example/case/add.do" class="form-horizontal">
		</#if>
			<div class="control-group">
				<label class="control-label">案例名称：</label>
				<div class="controls">
					<input name="name" type="text" value="${(case.name)!}" placeholder="" class="input-xlarge">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">封面图片：</label>
				<div class="controls">
					<input name="cover" type="text" value="${(case.cover.id)!}" readonly="readonly" placeholder="" class="input-xlarge">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="description" class="hide">${(case.description)!}</textarea>
					...
					<div class="wysiwyg-editor" id="text-editor">${(case.description)!}</div>
				</div>
			</div>
