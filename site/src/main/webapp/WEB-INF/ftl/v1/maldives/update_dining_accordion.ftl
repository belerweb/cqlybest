					...
					<div class="span12">
						<div class="control-group">
							...
							<div class="controls image-gallery">
								<button type="button" class="btn btn-primary btn-mini action action-add picture" data-name="diningId" data-value="${diningId}" data-url="${ContextPath}/maldives/dining/picture/add.do">添加</button>
