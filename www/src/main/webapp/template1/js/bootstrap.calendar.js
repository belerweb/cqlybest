...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'Calendar',
        ...
        template =  ''+
                        ...
                        '<span class="pull-right year"></span></h3>'+
                        '<table class="calendar" id="calendar">'+
                            '<thead class="calendar-header"></thead>'+
                            '<tbody class="calendar-body"></tbody>'+
                            '<tfoot>'+
                                '<th colspan="2" class="sel" id="last"><div class="arrow" title="上一月"><i class="icon-arrow-left"></i></div></th>'+
                                '<th colspan="3" class="sel" id="current">' +defaults.msg_today+ '</th>'+
                                '<th colspan="2" class="sel" id="next"><div class="arrow" title="下一月"><i class="icon-arrow-right"></i></div></th>'+
                            '</tfoot>'+
                        '</table>'+
                    '',
    ...
    Plugin.prototype.renderCalendar = function (date) {
        ...
        this.element.parent('div:first').find('.year').append(mon.getFullYear()+'年');
