...
public class AccountController {
  ...
  @RequestMapping(method = RequestMethod.GET, value = "/account/add.html")
  public void add() {}

  @RequestMapping(method = RequestMethod.POST, value = "/account/add.html")
  @ResponseBody
  ...
  @RequestMapping(method = RequestMethod.POST, value = "/account/modify.html")
  @ResponseBody
