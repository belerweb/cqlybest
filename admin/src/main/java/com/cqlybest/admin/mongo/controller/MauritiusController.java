...
import com.cqlybest.common.mongo.service.MauritiusService;
...
@Controller("mongoMauritiusController")
public class MauritiusController {

  @Autowired
  private MauritiusService mongoMauritiusService;
  @Autowired
  ...
  public String add(@RequestParam String zhName, @RequestParam String enName) {
    ...
    MauritiusHotel hotel = mongoMauritiusService.addHotel(zhName, enName);
    return hotel.getId();
  }
  ...
  public String update(@RequestParam String id, Model model) {
    model.addAttribute("hotel", mongoMauritiusService.getHotel(id));
  ...
  public void update(@RequestParam String pk, @RequestParam String name,
    ...
    mongoMauritiusService.updateHotel(pk, name, _value);
  }
  ...
  public String list(@RequestParam(defaultValue = "0") int page, Model model) {
    int pageSize = 10;
    model.addAttribute("result", mongoMauritiusService.queryHotel(page, pageSize));
  ...
  public Object list(@RequestParam String q, Model model) {
    return mongoMauritiusService.queryHotel(q, 10);
  }
  ...
  public void addRoom(@RequestParam String hotelId, @RequestParam String zhName,
    ...
    mongoMauritiusService.addRoom(hotelId, zhName, enName);
  }
  ...
  public void updateRoom(@RequestParam String pk, @RequestParam String name,
    ...
    mongoMauritiusService.updateRoom(pk, name, _value);
  }
  ...
  public Object room(@RequestParam String hotelId, @RequestParam String q, Model model) {
    return mongoMauritiusService.queryRoom(hotelId, q, 10);
  }
  ...
  public void addDining(@RequestParam String hotelId, @RequestParam String zhName,
      @RequestParam String enName) {
    mongoMauritiusService.addDining(hotelId, zhName, enName);
  }
  ...
  public void updateDining(@RequestParam String pk, @RequestParam String name,
    ...
    mongoMauritiusService.updateDining(pk, name, _value);
  }
  ...
  public void updatePicture(@RequestParam String pk, @RequestParam String name,
      @RequestParam String value) {
    mongoMauritiusService.updatePicture(pk, name, value);
  }
  ...
  public void deletePicture(@RequestParam String imageId) {
    mongoMauritiusService.deletePicture(imageId);
  }
  ...
  public void updateHotelPicture(@RequestParam String pk, @RequestParam String name,
      @RequestParam String value) {
    mongoMauritiusService.updateHotelPicture(pk, name, value);
  }
  ...
  public void deleteHotelPicture(@RequestParam String imageId) {
    mongoMauritiusService.deleteHotelPicture(imageId);
  }
  ...
  public void updateRoomPicture(@RequestParam String pk, @RequestParam String name,
      @RequestParam String value) {
    String[] tmp = pk.split("\\|");
    mongoMauritiusService.updateRoomPicture(tmp[0], tmp[1], name, value);
  }
  ...
  public void deleteRoomPicture(@RequestParam String imageId) {
    mongoMauritiusService.deleteRoomPicture(imageId);
  }
  ...
  public void updateDiningPicture(@RequestParam String pk, @RequestParam String name,
      @RequestParam String value) {
    String[] tmp = pk.split("\\|");
    mongoMauritiusService.updateDiningPicture(tmp[0], tmp[1], name, value);
  }
  ...
  public void deleteDiningPicture(@RequestParam String imageId) {
    mongoMauritiusService.deleteDiningPicture(imageId);
  }
