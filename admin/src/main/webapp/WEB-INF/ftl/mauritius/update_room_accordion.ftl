...
<style type="text/css">
#hotel-room-accordion .in.collapse, .tab-content {
	overflow: visible;
}
</style>
<div id="hotel-room-accordion" class="accordion">
	...
	<div class="accordion-group">
		...
		<div id="hotel-room-accordion-${room_index}" class="accordion-body collapse <#if room_index==0>in</#if>">
					...
					<div class="span12">
						<div class="control-group">
							...
							<div class="controls image-gallery">
								<button type="button" data-extra="mauritius-room-picture" data-extra-key="${roomId}" class="btn btn-primary action action-add picture">添加</button>
