			...
			<div class="tabbable">
				...
				<div class="tab-content">
					...
					<div id="hotel-poster-tab" class="image-gallery tab-pane">
						<div class="text-right"><button type="button" data-extra="mauritius-hotel-poster" data-extra-key="${id}" class="btn btn-primary action action-add picture">添加</button></div>
