...
<style type="text/css">
#hotel-dining-accordion .in.collapse, .tab-content {
	overflow: visible;
}
</style>
<div id="hotel-dining-accordion" class="accordion">
	...
	<div class="accordion-group">
		...
		<div id="hotel-dining-accordion-${dining_index}" class="accordion-body collapse <#if dining_index==0>in</#if>">
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls">
								<a href="#" class="editable" data-pk="${diningId}" data-name="reservation" data-type="select" data-url="${diningUrl}" data-value="<#if hotel.reservation?has_content><#if hotel.reservation>True<#else>False</#if></#if>"></a>
							</div>
						</div>
						<div class="control-group">
					...
					<div class="span12">
						<div class="control-group">
							...
							<div class="controls image-gallery">
								<button type="button" data-extra="mauritius-dining-picture" data-extra-key="${diningId}" class="btn btn-primary action action-add picture">添加</button>
