...
<div class="grid-content overflow">
	<form id="main-content-form" action="${ContextPath}/data/dict/add_traffic.html" method="post" class="form-horizontal">
		...
		$form.ajaxSubmit({
			success : function(response) {
				cqlybest.success(null, null, function(){
					$('#dict-main').load('${ContextPath}/data/dict/traffic.html');
				});
			},
			error : function() {
				cqlybest.error();
