					...
					<tr>
						...
						<td class="action-table">
							<a href="javascript:void(0);" data-url="${ContextPath}/account/modify.html?id=${account.id}"
								class="page-load-btn" data-target="#mb" title="修改">
								<img alt="修改" src="images/icon/table_edit.png">
							</a>
							<a href="javascript:void(0);" data-url="${ContextPath}/account/delete.html?id=${account.id}"
								...
								data-title="${account.name!}" title="删除">
								<img alt="删除" src="images/icon/table_del.png">
							</a>
						</td>
					</tr>
					</#list>
