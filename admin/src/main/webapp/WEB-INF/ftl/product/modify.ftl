								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input class="input-xxlarge" name="posters" type="text" readonly="readonly" value="${image!}">
											<button class="btn btn-danger" type="button" data-toggle="delete">删除</button>
										</div>
									</div>
								</div>
								</#list>
						...
						<div class="row-fluid">
							<div class="span12">
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input class="input-xxlarge" name="photos" type="text" readonly="readonly" value="${image!}">
											<button class="btn btn-danger" type="button" data-toggle="delete">删除</button>
										</div>
									</div>
								</div>
...
$('#main-content-form [data-toggle=delete]').click(function(){
