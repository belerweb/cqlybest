							...
							<div class="span12">
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<span class="add-on">￥</span>
											<input type="text" class="input-small" id="product-child-price" pattern="(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?" data-validation-pattern-message="价格是正数，最多两位小数">
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<span class="add-on">￥</span>
											<input type="text" class="input-small" id="product-special-price" pattern="(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?" data-validation-pattern-message="价格是正数，最多两位小数">
