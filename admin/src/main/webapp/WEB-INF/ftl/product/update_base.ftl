	...
	<div class="row-fluid">
		<div class="span6">
			...
			<div class="control-group">
				...
				<div class="controls">
					<a href="#" class="editable" data-dict="departure-city" data-pk="${ID}" data-name="departureCities" data-type="select2" data-url="${URL}" data-value="${(product.departureCities!)?html}">${(product.departureCities!)?html}</a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">目的地：</label>
				<div class="controls">
					<a href="#" class="editable" data-dict="destination" data-pk="${ID}" data-name="destinations" data-type="select2" data-url="${URL}" data-value="${(product.destinations!)?html}">${(product.destinations!)?html}</a>
				</div>
			</div>
			<div class="control-group">
		...
		<div class="span6">
			...
			<div class="control-group">
				...
				<div class="controls">
					<a href="#" class="editable" data-dict="tag" data-pk="${ID}" data-name="keywords" data-type="select2" data-url="${URL}" data-value="${(product.keywords!)?html}">${(product.keywords!)?html}</a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">交通方式：</label>
				<div class="controls">
					<a href="#" class="editable" data-dict="traffic" data-pk="${ID}" data-name="traffics" data-type="select2" data-url="${URL}" data-value="${(product.traffics!)?html}">${(product.traffics!)?html}</a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">产品类型：</label>
				<div class="controls">
					<a href="#" class="editable" data-dict="product-type" data-pk="${ID}" data-name="types" data-type="select2" data-url="${URL}" data-value="${(product.types!)?html}">${(product.types!)?html}</a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">产品等级：</label>
				<div class="controls">
					<a href="#" class="editable" data-dict="product-grade" data-pk="${ID}" data-name="grades" data-type="select2" data-url="${URL}" data-value="${(product.grades!)?html}">${(product.grades!)?html}</a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">推荐月份：</label>
				<div class="controls">
					<a href="#" class="editable" data-pk="${ID}" data-name="recommendedMonths" data-type="select2" data-url="${URL}" data-value="${(product.recommendedMonths!)?html}">${(product.recommendedMonths!)?html}</a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">适合人群：</label>
				<div class="controls">
					<a href="#" class="editable" data-pk="${ID}" data-name="crowds" data-type="select2" data-url="${URL}" data-value="${(product.crowds!)?html}">${(product.crowds!)?html}</a>
				</div>
			</div>
			<div class="clearfix"></div>
		</div>
...
$('#product-base-tab a.editable[data-type=text]').editable();
