		...
		<div class="tab-content" style="margin: 45px 0;">
			<div id="i-island" class="tab-pane active">
				...
				<div class="row-fluid">
					...
					<div class="span12"><img alt="${island.zhName}" src="http://${ImageServer}/${img.qiniuKey}?480/200" width="100%"></div>
				</div>
				</#if>
				<div class="p-l-r-5">
					<!-- 海岛描述 -->
			...
			<div class="p-l-r-5">
				...
				<div class="row-fluid m-b-5">
					...
					<#list imgs as img>
					<div class="span${12/imgs?size}"><img alt="${room.zhName}" src="http://${ImageServer}/${img.qiniuKey}?${480/imgs?size}/${(400/imgs?size)?string('0')}" width="100%"></div>
					</#list>
				</div>
