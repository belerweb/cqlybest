...
<div id="template1">
	...
	<ul class="tabs-nav">
		...
		<li>
			<a data-toggle="tab" href="javascript:void(0);" data-target="#template1-tab4">其他配置</a>
		</li>
	</ul>
	...
	<div class="grid-content">
		<div class="tab-content">
			...
			<div id="template1-tab4" class="tab-pane fade"><#include "/template1/other.ftl"></div>
		</div>
	</div>
</div>
