package com.cqlybest.common.bean.seychelles;
...
public class SeychellesIsland {
  ...
  private List<SeychellesRoom> rooms = new ArrayList<>();// 房型
  private List<SeychellesDining> dinings = new ArrayList<>();// 餐饮设施
  ...
  public List<SeychellesRoom> getRooms() {
    return rooms;
  }

  public void setRooms(List<SeychellesRoom> rooms) {
    this.rooms = rooms;
  }
  ...
  public List<SeychellesDining> getDinings() {
    return dinings;
  }

  public void setDinings(List<SeychellesDining> dinings) {
